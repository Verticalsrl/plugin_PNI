...
class ProgettoPNI:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&ProgettoPNI')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'ProgettoPNI')
        self.toolbar.setObjectName(u'ProgettoPNI')
    ...
    def inizializza_DB(self):
        ...
        try:
            ...
            try:
                ...
                cur.execute(open(sql_file, "r").read())
                sql_file = os.getenv("HOME") + '/.qgis2/python/plugins/ProgettoPNI/creazione_batch_schemi_e_tabelle.sql'
                cur.execute(open(sql_file, "r").read())
    ...
    def load_layers_from_db(self):
        ...
        try:
            ...
            for key, value in self.LAYER_NAME_PNI.items():
                ...
                layer.loadNamedStyle(os.getenv("HOME")+'/.qgis2/python/plugins/ProgettoPNI/qml_base/%s.qml' % (value))
                crs = layer.crs()
    ...
    def exportDB(self):
        ...
        try:
            ...
            for layer in reversed(layers): #reversed order cosi mantengo l'ordine originale
                ...
                re_layer.loadNamedStyle( os.getenv("HOME")+'/.qgis2/python/plugins/ProgettoPNI/qml_base/%s.qml' % (nome) )
...
PFS: %(id_pfs)s"""
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('ProgettoPNI', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/ProgettoPNI/download.png'
        self.add_action(
            icon_path,
        ...
        """
        icon_path = ':/plugins/ProgettoPNI/append_C83737.png'
        self.add_action(
            icon_path,
        ...
        icon_path = ':/plugins/ProgettoPNI/grouping_C83737.png'
        self.add_action(
            icon_path,
        ...
        icon_path = ':/plugins/ProgettoPNI/compare_C83737.png'
        self.add_action(
            icon_path,
        ...
        icon_path = ':/plugins/ProgettoPNI/cavo_route_C83737.png'
        self.add_action(
            icon_path,
        ...
        icon_path = ':/plugins/ProgettoPNI/export.png'
        self.add_action(
            icon_path,
        ...
        """
        icon_path = ':/plugins/ProgettoPNI/computo_C83737.png'
        self.add_action(
            icon_path,
        ...
        icon_path = ':/plugins/ProgettoPNI/counting_C83737.png'
        self.add_action(
            icon_path,
        ...
        icon_path = ':/plugins/ProgettoPNI/razor_blade_C83737.png'
        self.add_action(
            icon_path,
        ...
        icon_path = ':/plugins/ProgettoPNI/overlap_C83737.png'
        self.add_action(
            icon_path,
        ...
        icon_path = ':/plugins/ProgettoPNI/calc_C83737.png'
        self.add_action(
            icon_path,
        ...
        icon_path = ':/plugins/ProgettoPNI/update_C83737.png'
        self.add_action(
            icon_path,
        ...
        icon_path = ':/plugins/ProgettoPNI/network_C83737.png'
        self.add_action(
            icon_path,
        ...
        icon_path = ':/plugins/ProgettoPNI/help.png'
        self.add_action(
            icon_path,
    ...
    def run_updatedb(self):
        ...
        try:
            ...
            sql_file = os.getenv("HOME") + '/.qgis2/python/plugins/ProgettoPNI/creazione_funzione_scalcable.sql'
            cur_updatedb.execute(open(sql_file, "r").read())
            conn_updatedb.commit()
...
JOIN
    ...
    def run_help(self):
        ...
        nome_file = os.getenv("HOME")+'/.qgis2/python/plugins/ProgettoPNI/metadata.txt'
